...
std::unique_ptr<Node> parse_break_stmt(Parser* parser) {
    ...
    parser->consume_token(); // 'break'
    parser->expect(TokenType::SEMICOLON, "Expected ';' after break.");
    ...
    auto node = std::make_unique<BreakStmtNode>();
